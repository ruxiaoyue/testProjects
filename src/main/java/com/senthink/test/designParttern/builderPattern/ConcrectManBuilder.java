 ...
 */
public class ConcrectManBuilder implements Builder{

    private final static Logger LOGGER = LoggerFactory.getLogger(ConcrectManBuilder.class);

    private Person person;

    public ConcrectManBuilder() {
        person = new Person();
    }
